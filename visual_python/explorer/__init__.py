...
class Explorer(ttk.Treeview):
    def __init__(self, master, window):
        ...
        self.explorer_file_image = tk.PhotoImage(file='visual_python/icons/file_icons/file.png')
        self.explorer_python_file_image = tk.PhotoImage(file='visual_python/icons/file_icons/python-file.png')
        self.explorer_folder_image = tk.PhotoImage(file='visual_python/icons/file_icons/folder.png')
